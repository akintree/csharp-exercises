...
namespace CountingCharacters
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //the program coudn't find the file String.txt even though it was in what i believe was the correct folder. may revisit later.
            //using (StreamReader content = new StreamReader("String.txt"))
            {
                //string read = content.ReadToEnd();
